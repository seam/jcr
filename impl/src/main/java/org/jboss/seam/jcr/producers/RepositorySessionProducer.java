...
public class RepositorySessionProducer {
    ...
    /**Produces a javax.jcr.Repository based on org.jboss.seam.jcr.annotations.JcrRepository
     *
    ...
    /** Creates a logged in session to the repository.
