...
public class RepositoryInjectModeshapeTest extends RepositoryInjectTest {
    @Deployment(name="RepositoryInjectModeshape")
    public static WebArchive createArchive() {
        return updateArchive(Utils.baseModeshapeDeployment()
                .addClass(ModeshapeRepositoryResolverProducer.class)
                .addClass(RepositoryInjectModeshapeTest.class));             
    }
}
