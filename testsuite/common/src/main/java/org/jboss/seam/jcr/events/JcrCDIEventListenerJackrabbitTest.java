...
import org.jboss.seam.jcr.producers.JackrabbitRepositoryResolverProducer;
...
public class JcrCDIEventListenerJackrabbitTest extends JcrCDIEventListenerTest {

    @Deployment(name="JcrCDIEventListenerJackrabbit")
    public static WebArchive createArchive() {
        return updateArchive(Utils.baseJackrabbitDeployment())
            .addClass(JcrCDIEventListenerJackrabbitTest.class)
