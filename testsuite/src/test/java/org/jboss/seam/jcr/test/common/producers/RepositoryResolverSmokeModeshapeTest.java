...
public class RepositoryResolverSmokeModeshapeTest extends RepositoryResolverSmokeTest {
    @Deployment(name="RepositoryResolverSmokeModeshape")
    public static WebArchive createArchive() {
        return updateArchive(Utils.baseModeshapeDeployment()
                .addClass(ModeshapeRepositoryResolverProducer.class)
                .addClass(RepositoryResolverSmokeModeshapeTest.class));             
    }
}
